...
Current and historical timeline events are refreshed every run. Previously rejected or unsupported audit records are rechecked oldest-first in bounded batches, spreading that background work across runs instead of sending a large burst to the public API.
